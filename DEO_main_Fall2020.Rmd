...
* Syllabus [(.pdf)](Optim_Class_Fall2019/Syllabus _AAEC6305_Fall2020.pdf)  

* Introduction 
<br>
   *  Week 1: Overview of optimization models and MATLAB  
      * MATLAB and CompEcon Toolbox installation instructions 
      [(.pdf)](Optim_Class_Fall2019/softwareInstall/install_MATLAB_COMPECON.pdf)
      * Syntax Cross-Refernece Sheet
      [(.pdf)](Optim_Class_Fall2019/xRef/xRef_Matlab_Python_R.pdf)  
      * Getting Started With Matlab, Part1
      [(.mlx)](Optim_Class_Fall2019/GettingStartedWithMatlab_Part1.mlx)
...
<br>
   *  Week 2: Linear and nonlinear static models 
      * Getting Started With Matlab, Part2
      <!-- [(.mlx)](Optim_Class_Fall2019/GettingStartedWithMatlab_Part2.mlx) -->
      ...
      * nonLinear Static Models
      <!--[(.mlx)](Optim_Class_Fall2019/nonLinearStaticModels.mlx)-->
...
* Deterministic Dynamic Models  
   *  Week 3: Nonrenewable resource extraction (Mine management) and Livestock feeding model
      *  Deterministic Dynamic Models
      <!--[(.mlx)](Optim_Class_Fall2019/Deterministic_Dynamic_Models.mlx)  -->
      *   Mine Management Extension <!--[(.m)](Optim_Class_Fall2019/mineExt.m)  -->
<br>
* Stochastic Dynamic Models  
    *  Week 4: Water management
         *   Stochastic Dynamic Models
         <!--[(.mlx)](Optim_Class_Fall2019/Stochastic_Dynamic_Models.mlx)-->
         *   Stochastic Dynamic Models Extension
         <!--[(.mlx)](Optim_Class_Fall2019/Stochastic_Dynamic_Models_CD.mlx)-->
...
* Continuous Time Dynamic Models  
    *  Week 5: Nonrenewable Resource Management & The Neoclassical Growth Model
         *   Continuous Time_Dynamic Models
         <!--[(.mlx)](Optim_Class_Fall2019/Continuous_Time_Dynamic_Models.mlx) --> 
         *   Model Function File for Optimal Growth Model
         <!--[(.m)](Optim_Class_Fall2019/mfsc01.m)  -->
         ...
         *   Dynamic Programming vs. Optimal Control
         <!--[(.mlx)](Optim_Class_Fall2019/Dynamic_Programming_vs_Optimal_Control.mlx)-->  
