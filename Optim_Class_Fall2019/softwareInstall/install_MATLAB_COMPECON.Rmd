...
![](/Users/malooney/Documents/malooney.github.io/Optim_Class_Fall2019/softwareInstall/setPath.png){ width=75% }
  ...
  9.  If you created a folder called "Optim_Class_Fall_2019" in your MATLAB folder then all you need to do is simply copy files into this folder and the files will be automatically added to the MATLAB path. EASY!
